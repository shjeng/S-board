...
const InputBox = forwardRef<HTMLInputElement, Props>((props: Props, ref) =>{
  ...
  // state: properties
  const {label,type,error,placeholder,value,icon,message,readonly} = props;
  ...
  return (
    <div className='inputbox'>
      ...
      <div className={error ? 'inputbox-container-error' : 'inputbox-container'}>
        {readonly ?
          <input ref={ref} type={type} className='input' placeholder={placeholder} value={value} onChange={onChange} onKeyDown={onKeyDownHandler} readOnly/>
          :
