...
import defulatProfileImage from 'assets/image/default-profile-image.png'
...
const UserPage = () => {
  ...
  const UserTop = () =>{
    ...
    const getUserResponse = (respnoseBody: GetUserResponseDto | ResponseDto | null) => {
      if(!respnoseBody) return;
      const {code} = respnoseBody;
      ...
      const { email, nickname, profileImage} = respnoseBody as GetUserResponseDto;
    ...
    <div id='user-top-wrapper'>
      ...
      <div className='user-top-container'>
        ...
        <div className='user-top-profile-image-box' style={{backgroundImage: `url(${profileImage ? profileImage : defulatProfileImage})`}}></div>
        }
  ...
  const UserBottom = () => {
    ...
    //        effect: userEmail path varable이 변경될 때마다 실행할 함수        //
    useEffect(()=>{
      if(!userEmail) return;
        ...
        <div className='user-bottom-container'>
          ...
          <div className='user-bottom-contents-box'>
            ...
            <div className='user-bottom-contents'>
              {viewList.map(boadListItem=> <BoardItem boardListItem={boadListItem} />)}
            </div>
          }
