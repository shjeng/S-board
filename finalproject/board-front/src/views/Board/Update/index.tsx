...
const BoardWrite = () => {
  ...
  const getBoardResponse = (responseBody: GetBoardResponseDto | ResponseDto | null) =>{
    ...
    // 이미지 url들을 받아오고 이 url에서 파일들을 추출한 뒤에 board store에 파일들을 넘겨준다.
  ...
  const onImageUploadButtonClickHanlder = () =>{
    if(!imageInputRef.current) return;
      ...
      <div className='board-update-container'>
        <div className='board-update-box'>
          ...
          <div className='board-update-content-box'>
            ...
            <div className='icon-button' onClick={onImageUploadButtonClickHanlder}>
              <div className='icon image-box-light-icon'></div>
            </div>
            <input ref={imageInputRef} type='file' accept='image/*' style={{display:'none'}} onChange={onImageChangeHandler}/> {/* accept='image/*' : 모든 이미지 파일 */}
          </div>
