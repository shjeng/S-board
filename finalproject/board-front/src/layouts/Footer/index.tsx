      ...
      <div className='footer-container'>
        <div className='footer-top'>
          <div className='footer-logo-box'>
            ...
            <div className='footer-logo-text'>{'S Board'}</div>
          </div>
          <div className='footer-link-box'>
            <div className='footer-email-link'>{'ghsmsl20@gmail.com'}</div>
        ...
        <div className='footer-bottom'>
          <div className='footer-copyright'>{'Copyright © 2023 SihwaCompany. All Rights Reserved'}</div>
        </div>
      </div>
    </div>
  );
